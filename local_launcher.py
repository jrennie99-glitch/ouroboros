...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="qwen/qwen3-235b-a22b:free")
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="qwen/qwen3-235b-a22b:free")
MODEL_LIGHT = get_cfg("OUROBOROS_MODEL_LIGHT", default="qwen/qwen3-235b-a22b:free")

...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="qwen3.5:9b")
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="qwen2.5-coder:7b")
MODEL_LIGHT = get_cfg("OUROBOROS_MODEL_LIGHT", default="qwen3.5:4b-fast")

...
MODEL_MAIN = get_cfg("OUROBOROS_MODEL", default="nvidia/nemotron-3-super-120b-a12b:free")
MODEL_CODE = get_cfg("OUROBOROS_MODEL_CODE", default="nvidia/nemotron-3-super-120b-a12b:free")
MODEL_LIGHT = get_cfg("OUROBOROS_MODEL_LIGHT", default="nvidia/nemotron-3-super-120b-a12b:free")
